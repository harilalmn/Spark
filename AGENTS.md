...
- `dotnet test Spark.slnx` — **1,130 tests across eight projects**, all passing. The same
  1,130 are reported by `scripts/run-tests.sh`, which runs each project as the executable
