...
- `dotnet test Spark.slnx` — **1,196 tests across eight projects**, all passing. The same
  1,196 are reported by `scripts/run-tests.sh`, which runs each project as the executable
