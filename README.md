...
> the suite runs **1,115 passing tests** across seven projects — counted by
...
The suite is **1,115 tests** across seven projects. `Spark.Geometry.Tests` (429) and
`Spark.Geometry.Properties` (56) cover the kernel by example and by CsCheck property
