...
**Last updated:** 2026-09-11 (`E3-T20` step B done; the application opens a bundle next)
...
>    the importer's ~~**`E5-T9`**~~ and ~~**`E5-T10`**~~ (done 2026-09-11), then ~~**`E3-T21`**~~ (done 2026-09-11, on the evidence), ~~**`E3-T14`**~~ (done 2026-09-11: a slow run's nodes show as evaluating, the stroke travelling) and **`E3-T20`** (steps A and B done 2026-09-11: a bundle packs and opens, and `spark pack` makes one; the application next).
