...
**Last updated:** 2026-09-11 (`E3-T14` step A done; step B, the travelling stroke, next)
...
>    the importer's ~~**`E5-T9`**~~ and ~~**`E5-T10`**~~ (done 2026-09-11), then ~~**`E3-T21`**~~ (done 2026-09-11, on the evidence), **`E3-T14`** (step A done 2026-09-11: a slow run's nodes show as evaluating until they finish) and **`E3-T20`**.
