...
**Last updated:** 2026-09-01 (E6-T22 to E6-T25, E9-T13 and E8-T33 to E8-T36 closed: the code editor's IntelliSense and Selection menu, typed code-block outputs, the two docking defects, click-to-connect, node names and colours, and Dynamo-style port lozenges)
