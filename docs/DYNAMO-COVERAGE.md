...
**Last updated:** 2026-09-14 (`E2-T68`: Laplacian smoothing; 438 of 545)
...
> checks it against this document on every build. **As of 2026-09-13 it stands at `Done` 438,
> `Planned` 78, `Not planned` 123, `Needs a decision` 198 and `Unassessed` 0**, which is 837 — and
...
>
> **The move from 392 to 438 on 2026-09-13 and 2026-09-14 is the first this register has made by *building*
...
**Where the 438 sit.** Every subsystem except T-Splines — which is the sentence this section could
...
this document.** A large share of the 438 are the easiest members in the inventory: arithmetic on
...
if it is ever written rather than delegated (§6.1, ADR-0020). And the 107 still to build are not the
