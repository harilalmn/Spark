...
**Last updated:** 2026-09-13 (`E2-T66`: `Surface.ToNurbsSurface` on the base; 422 of 545)
...
> checks it against this document on every build. **As of 2026-09-13 it stands at `Done` 422,
> `Planned` 94, `Not planned` 123, `Needs a decision` 198 and `Unassessed` 0**, which is 837 — and
...
> the largest), §3.3 (51 of 106), §3.4 (24 of 55), §3.5 (31 of 33), §3.6 (41 of 65) and §3.8 (24 of
> 89). §3.7's 169 T-Spline members are `Q12`'s decision and are not an assessment.
>
> **The move from 392 to 422 on 2026-09-13 is the first this register has made by *building*
...
**Where the 422 sit.** Every subsystem except T-Splines — which is the sentence this section could
not say for the first year of its life, when it read *all 99 sit in one subsystem, because that is
the only subsystem that exists*. Values and frames is 113 of 133, curves 138 of 187, surfaces 51 of
...
this document.** A large share of the 422 are the easiest members in the inventory: arithmetic on
...
if it is ever written rather than delegated (§6.1, ADR-0020). And the 123 still to build are not the
...
### 3.3 Surfaces — 5 types, 106 members, 51 reachable
...
| Dynamo type | Members | Reachable | Spark equivalent | Status | Milestone |
|---|---:|---:|---|---|---|
| `Surface` (base) | 46 | 29 | `Surface`, `Spark.Api.IBrepKernel` | Partial | M5 |
