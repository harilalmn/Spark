...
**Last updated:** 2026-09-13 (`E2-T72`: the tangent-constrained interpolation; 419 of 545)
...
> checks it against this document on every build. **As of 2026-09-13 it stands at `Done` 419,
> `Planned` 97, `Not planned` 123, `Needs a decision` 198 and `Unassessed` 0**, which is 837 — and
...
>
> **The move from 392 to 419 on 2026-09-13 is the first this register has made by *building*
...
**Where the 419 sit.** Every subsystem except T-Splines — which is the sentence this section could
not say for the first year of its life, when it read *all 99 sit in one subsystem, because that is
the only subsystem that exists*. Values and frames is 113 of 133, curves 138 of 187, surfaces 48 of
...
this document.** A large share of the 419 are the easiest members in the inventory: arithmetic on
...
if it is ever written rather than delegated (§6.1, ADR-0020). And the 126 still to build are not the
