...
**Last updated:** 2026-09-14 (`E2-T69`: the four mesh primitives; 434 of 545)
...
> checks it against this document on every build. **As of 2026-09-13 it stands at `Done` 434,
> `Planned` 82, `Not planned` 123, `Needs a decision` 198 and `Unassessed` 0**, which is 837 — and
...
> the largest), §3.3 (59 of 106), §3.4 (24 of 55), §3.5 (31 of 33), §3.6 (45 of 65) and §3.8 (24 of
> 89). §3.7's 169 T-Spline members are `Q12`'s decision and are not an assessment.
>
> **The move from 392 to 434 on 2026-09-13 and 2026-09-14 is the first this register has made by *building*
...
**Where the 434 sit.** Every subsystem except T-Splines — which is the sentence this section could
...
106, topology 31 of 33, mesh 45 of 65, solids 24 of 55 and infrastructure 24 of 89. Thirteen types
...
this document.** A large share of the 434 are the easiest members in the inventory: arithmetic on
...
if it is ever written rather than delegated (§6.1, ADR-0020). And the 111 still to build are not the
...
### 3.6 Mesh — 2 types, 65 members, 45 reachable
...
| Dynamo type | Members | Reachable | Spark equivalent | Status | Milestone |
|---|---:|---:|---|---|---|
| `Mesh` | 55 | 35 | `Mesh`, `MeshTopology`, `Spark.Geometry.Io`, `Spark.Api.IBrepKernel` | Partial | M5, M6 |
