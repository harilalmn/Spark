...
**Last updated:** 2026-09-13 (`E2-T71`: `PolyCurve.ToNurbsCurve`; 418 of 545)
...
> checks it against this document on every build. **As of 2026-09-13 it stands at `Done` 418,
> `Planned` 98, `Not planned` 123, `Needs a decision` 198 and `Unassessed` 0**, which is 837 — and
...
> **All seven sections are now assessed member by member**: §3.1 (113 of 133), §3.2 (**137 of 187**,
...
>
> **The move from 392 to 418 on 2026-09-13 is the first this register has made by *building*
...
**Where the 418 sit.** Every subsystem except T-Splines — which is the sentence this section could
not say for the first year of its life, when it read *all 99 sit in one subsystem, because that is
the only subsystem that exists*. Values and frames is 113 of 133, curves 137 of 187, surfaces 48 of
...
this document.** A large share of the 418 are the easiest members in the inventory: arithmetic on
...
if it is ever written rather than delegated (§6.1, ADR-0020). And the 127 still to build are not the
...
### 3.2 Curves — 11 types, 187 members, 137 reachable
...
**137 of 187**, as `Done` 137, `Planned` 24, `Needs a decision` 18, `Not planned` 8. **`Line` and
