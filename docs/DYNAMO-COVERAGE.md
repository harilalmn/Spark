...
**Last updated:** 2026-09-14 (`E2-T69`: the mesh primitives and two queries; 436 of 545)
...
> checks it against this document on every build. **As of 2026-09-13 it stands at `Done` 436,
> `Planned` 80, `Not planned` 123, `Needs a decision` 198 and `Unassessed` 0**, which is 837 — and
...
> **All seven sections are now assessed member by member**: §3.1 (113 of 133), §3.2 (**138 of 187**,
> the largest), §3.3 (59 of 106), §3.4 (24 of 55), §3.5 (31 of 33), §3.6 (47 of 65) and §3.8 (24 of
> 89). §3.7's 169 T-Spline members are `Q12`'s decision and are not an assessment.
>
> **The move from 392 to 436 on 2026-09-13 and 2026-09-14 is the first this register has made by *building*
...
**Where the 436 sit.** Every subsystem except T-Splines — which is the sentence this section could
not say for the first year of its life, when it read *all 99 sit in one subsystem, because that is
the only subsystem that exists*. Values and frames is 113 of 133, curves 138 of 187, surfaces 59 of
106, topology 31 of 33, mesh 47 of 65, solids 24 of 55 and infrastructure 24 of 89. Thirteen types
...
this document.** A large share of the 436 are the easiest members in the inventory: arithmetic on
...
if it is ever written rather than delegated (§6.1, ADR-0020). And the 109 still to build are not the
...
### 3.2 Curves — 11 types, 187 members, 138 reachable
...
**138 of 187**, as `Done` 138, `Planned` 23, `Needs a decision` 18, `Not planned` 8. **`Line` and
...
### 3.6 Mesh — 2 types, 65 members, 47 reachable
...
| Dynamo type | Members | Reachable | Spark equivalent | Status | Milestone |
|---|---:|---:|---|---|---|
| `Mesh` | 55 | 37 | `Mesh`, `MeshTopology`, `Spark.Geometry.Io`, `Spark.Api.IBrepKernel` | Partial | M5, M6 |
