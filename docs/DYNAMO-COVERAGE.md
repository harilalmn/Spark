...
**Last updated:** 2026-09-14 (`E2-T72`: a polyline asked about itself; 439 of 545)
...
> checks it against this document on every build. **As of 2026-09-13 it stands at `Done` 439,
> `Planned` 77, `Not planned` 123, `Needs a decision` 198 and `Unassessed` 0**, which is 837 — and
...
> **All seven sections are now assessed member by member**: §3.1 (113 of 133), §3.2 (**139 of 187**,
...
>
> **The move from 392 to 439 on 2026-09-13 and 2026-09-14 is the first this register has made by *building*
...
**Where the 439 sit.** Every subsystem except T-Splines — which is the sentence this section could
not say for the first year of its life, when it read *all 99 sit in one subsystem, because that is
the only subsystem that exists*. Values and frames is 113 of 133, curves 139 of 187, surfaces 59 of
...
this document.** A large share of the 439 are the easiest members in the inventory: arithmetic on
...
if it is ever written rather than delegated (§6.1, ADR-0020). And the 106 still to build are not the
...
### 3.2 Curves — 11 types, 187 members, 139 reachable
...
**139 of 187**, as `Done` 139, `Planned` 22, `Needs a decision` 18, `Not planned` 8. **`Line` and
