...
**Owner:** Nicety
**Last updated:** 2026-09-11 (FR-60: the Clipper2 pipeline is complete; Curve2d remains)
...
| FR-60 | `Spark.Geometry.Planar`: `Point2d`/`Curve2d`, `Region`, and the Clipper2-backed boolean, offset and simplify pipeline, bridged by `Plane.To2d`/`To3d`. Not a peer 2D API. | **Partly met** (E2-T13). `Region`, the four booleans, offset and simplify landed 2026-09-11, through Clipper2 from one internal file; `Point2d` and the plane bridges already existed. **`Curve2d` is still to come.** |
