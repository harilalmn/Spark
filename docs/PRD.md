...
**Owner:** Nicety
**Last updated:** 2026-09-11 (FR-60 partly met: Region and the planar booleans)
...
| FR-60 | `Spark.Geometry.Planar`: `Point2d`/`Curve2d`, `Region`, and the Clipper2-backed boolean, offset and simplify pipeline, bridged by `Plane.To2d`/`To3d`. Not a peer 2D API. | **Partly met** (E2-T13). `Region` and the four booleans landed 2026-09-11, through Clipper2 from one internal file; `Point2d` and the plane bridges already existed. Offset, simplify and `Curve2d` are still to come. |
