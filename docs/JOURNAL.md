...
**Last updated:** 2026-09-11 (`E3-T20` step A: the .sparkz bundle)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps.** `E3-T20` step A is committed: `SparkBundle` packs and opens `.sparkz`. Next is step B, the command line. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
