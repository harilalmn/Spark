...
**Last updated:** 2026-09-11 (`E2-T13` closed; `Curve2d` filed as `E2-T64`)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps.** TODO item 9's geometry breadth is done; next is the importer's `E5-T9`. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
