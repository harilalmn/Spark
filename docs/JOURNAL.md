...
**Last updated:** 2026-09-11 (`E5-T9` closed: extension methods on their receiver)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps, and `E5-T9` is closed.** Next is `E5-T10`, generic methods - a decision before it is code. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
