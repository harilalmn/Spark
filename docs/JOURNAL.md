...
**Last updated:** 2026-09-11 (`E11-T23` step A: the Dynamo parity manifest)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps.** `E11-T23` step A is committed: the Dynamo parity manifest and three checks. Next is step B, the reverse direction and the review of the name matches. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
