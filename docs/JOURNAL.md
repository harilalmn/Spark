...
**Last updated:** 2026-09-11 (`E2-T16` closed: Point.PruneDuplicates on the k-d tree)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps, and `E2-T16` is closed.** Next is `E2-T21`, `PointCloud` and `GeometryGroup`. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
