...
**Last updated:** 2026-09-11 (`E8-T12` closed: Settings)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps, and `E8-T12` is closed.** Settings is one window over the preferences that already persisted. Next is the geometry breadth in TODO item 9, starting with `E2-T11`. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
