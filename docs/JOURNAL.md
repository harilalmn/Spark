...
**Last updated:** 2026-09-11 (`E8-T86`: the newest run wins, not the last to finish)
**Protocol version:** 2
...
| **Working on** | **`E2-T11` step B1 — the general curve/curve intersector.** `E8-T86` is committed: the newest run wins. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
