...
**Last updated:** 2026-09-11 (`E3-T12` step A: the kernel's long loop takes a cancellation token)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps; `E3-T12` step A is committed and step B is next.** Tessellation can be cancelled from inside its loop; no library node receives the evaluator's token yet. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*.** |
