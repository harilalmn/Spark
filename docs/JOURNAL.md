...
**Last updated:** 2026-09-11 (`E8-T13` closed: autosave and crash recovery)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps, and `E8-T13` is closed.** A working copy is kept after every unsaved change and a crashed session's graph is offered back on the next start; checked by killing a real Spark. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*.** |
