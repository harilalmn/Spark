...
**Last updated:** 2026-09-11 (`E3-T21` closed on the evidence)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps.** `E3-T21` closed on the evidence; next is `E3-T14`, the rest of the progress channel. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
