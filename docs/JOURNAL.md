...
**Last updated:** 2026-09-11 (`E9-T8` closed: a click on geometry selects the node that drew it)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps, and `E9-T8` is closed.** A click on geometry selects the node that drew it. Next is `E9-T7`, the other open viewport row. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*.** |
