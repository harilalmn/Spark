...
**Last updated:** 2026-09-11 (`E9-T7` closed: tessellation is parallel and streams during a run)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps, and `E9-T7` is closed.** The viewport epic (`E9`) has no open row: picking, parallel tessellation and streaming all landed today. Next is `E8-T12`, Settings. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
