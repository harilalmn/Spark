...
**Last updated:** 2026-09-02 00:20 +0530
**Protocol version:** 2
...
| **Next action** | **Ask the client how far the rest of the Dynamo look should go.** The ports are lozenges, the headers are grey; what is left is the node body and the wires — Dynamo's body is lighter than its header and its wires are thicker and paler. **Then the queue as it stood**: cut the first release when the client says so, then the Help pass. **And a dirty flag is owed**, because New and Open both discard unsaved work without asking. |
