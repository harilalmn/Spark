...
**Last updated:** 2026-09-11 (`E3-T19` closed on the evidence)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps.** `E3-T19` closed on the evidence; next is `E11-T23` step B, as below. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
