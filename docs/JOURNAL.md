...
**Last updated:** 2026-09-11 (`E3-T14` closed: the evaluating stroke travels)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps, and `E3-T14` is closed.** Next is `E3-T20`, the `.sparkz` container. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
