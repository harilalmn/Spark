...
**Last updated:** 2026-09-11 (`E9-T8` step A: the viewport can say what is under a pixel)
**Protocol version:** 2
...
| **Working on** | **`E9-T8` step B — a click in the viewport selects the node that drew the geometry.** Step A is committed: `Camera.RayThrough` and `ViewportPicker.Pick` in `Spark.Viewport`. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*.** |
