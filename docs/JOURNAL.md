...
**Last updated:** 2026-09-11 (`E2-T11` step B2: Curve.IntersectWith is public)
**Protocol version:** 2
...
| **Working on** | **`E2-T11` step C — the nodes.** B2 is committed: `Curve.IntersectWith` is the one public entry point. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
