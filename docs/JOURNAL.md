...
**Last updated:** 2026-09-13 (`E2-T72` first idea in progress: curve fitting, of which Spark has none)
**Protocol version:** 2
...
| **Working on** | **`E2-T72`'s first idea — there is no curve fitting of any kind.** Three closed-form fits over machinery that already exists. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
