...
**Last updated:** 2026-09-11 (`E3-T12` closed: the evaluation's token reaches the kernel's long loop and the nodes that ask for it)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps, and `E3-T12` is closed.** Cancellation reaches tessellation and any node method that declares a token; OpenCascade calls remain uninterruptible, and the help says so. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*.** |
