...
**Last updated:** 2026-09-11 (`E3-T20` step D: --open takes a bundle)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps, and `E3-T20` is closed with step D.** Next is `E11-T23`, as below. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
