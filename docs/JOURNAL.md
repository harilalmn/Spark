...
**Last updated:** 2026-09-11 (`E2-T16` step A: a k-d tree over points)
**Protocol version:** 2
...
| **Working on** | **`E2-T16` step B — `Point.PruneDuplicates`.** Step A is committed: `PointKdTree` answers nearest, k nearest and within-a-radius, checked against brute force. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
