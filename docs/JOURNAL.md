...
**Last updated:** 2026-09-11 (`E2-T11` step A: curve/curve intersection in closed form)
**Protocol version:** 2
...
| **Working on** | **`E2-T11` step B — the general curve/curve intersector.** Step A is committed: `AnalyticCurveIntersection` answers lines, circles and arcs in closed form, internally. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
