...
**Last updated:** 2026-09-11 (`E2-T21` closed: PointCloud)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps, and `E2-T21` is closed.** Next is `E2-T13`, the planar layer. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
