...
**Last updated:** 2026-09-11 (`E2-T11` step B1: the general curve/curve intersector)
**Protocol version:** 2
...
| **Working on** | **`E2-T11` step B2 — curve/curve intersection becomes public.** B1 is committed: `GeneralCurveIntersection` answers any two curves, internally, and agrees with the closed forms. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
