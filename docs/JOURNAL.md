...
**Last updated:** 2026-09-11 (`E9-T7` step A: tessellation is parallel)
**Protocol version:** 2
...
| **Working on** | **`E9-T7` step B — geometry streamed to the viewport as nodes finish.** Step A is committed: tessellation is parallel inside `SceneBuilder`. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*.** |
