...
**Last updated:** 2026-09-11 (`E2-T11` closed: curve/curve intersection as nodes)
**Protocol version:** 2
...
| **Working on** | **Nothing — between steps, and `E2-T11` is closed.** Curve/curve intersection is in the kernel and in the node library. Next is `E2-T16`, the k-d tree. **Run parameters from the client, 2026-09-11: *go non stop till all Epics are done*, then *finish everything - we release only after that*: no tag or release until the register is worked out.** |
