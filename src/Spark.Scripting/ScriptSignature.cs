...
/// parameter the caret is on, and a caller given <c>FromCenterNormalRadius(Point3d center, …)</c> as
...
/// — <c>Circle.FromCenterNormalRadius(</c> has no arguments at all, so overload resolution fails —
