...
public sealed class SceneBuilderTests
{
    ...
    public void ALargeCurveDoesNotCostMoreSegmentsThanASmallOne()
    {
        ...
        small.Add(Key, Circle.FromCenterRadius(Point3d.Origin, 1.0));

        SceneBuilder large = new();
        large.Add(Key, Circle.FromCenterRadius(Point3d.Origin, 1000.0));
    ...
    public void ListsOfDisplayedCurvesAreWalkedAndColoured()
    {
        ...
        [
            new Displayable(Circle.FromCenterRadius(Point3d.Origin, 1.0), new Spark.Api.Appearance(new Rgba(10, 20, 30))),
