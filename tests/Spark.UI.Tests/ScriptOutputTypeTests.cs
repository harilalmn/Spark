...
public sealed class ScriptOutputTypeTests : IDisposable
{
    ...
    {
        ScriptPort output = Single("return Circle.FromCenterRadius(new Point3d(10, 10, 0), 10);");
    ...
    {
        const string Script = "return Circle.FromCenterRadius(new Point3d(0, 0, 0), 5.0);";
